    ...
    <el-card class="box-card">
      ...
      <div class="content">
        <el-row :gutter="20" style="margin-bottom: 20px">
          <el-col :span="6">
            <el-input v-model="searchText" placeholder="搜索商品" clearable :maxlength="50"/>
          </el-col>
          <el-col :span="4">
            <el-button type="primary" @click="handleAddProduct" icon="el-icon-plus"> 添加商品 </el-button>
          </el-col>
          <el-col :span="4">
            <el-button type="success" @click="handleBatchPublish" icon="el-icon-upload"> 批量上架 </el-button>
          </el-col>
        </el-row>
        ...
        >
          ...
          <el-table-column label="操作" width="150" fixed="right">
            <template #default="scope">
              ...
              <el-button
                :type="scope.row.status === 'published' ? 'info' : 'success'"
                size="small"
    ...
    <el-dialog :title="dialogTitle" v-model="dialogVisible" width="500px" @close="handleDialogClose">
      <el-form :model="formData" :rules="formRules" ref="productForm" label-width="100px">
        ...
        <el-form-item label="价格" prop="price">
          <el-input-number v-model="formData.price" :min="0" :max="999999" :precision="2" :step="0.1"/>
        </el-form-item>
