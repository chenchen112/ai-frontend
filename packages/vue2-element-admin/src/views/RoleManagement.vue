...
export default {
  ...
  methods: {
    fetchRoles() {
      ...
      setTimeout(() => {
        this.roleList = [
          { id: 1, name: '系统管理员', code: 'admin', description: '拥有系统所有权限', status: 'active' },
          { id: 2, name: '业务经理', code: 'manager', description: '负责业务运营管理', status: 'active' },
          { id: 3, name: '普通员工', code: 'employee', description: '日常业务操作人员', status: 'active' },
          { id: 4, name: '访客', code: 'guest', description: '只读权限', status: 'inactive' }
        ]
        this.loading = false
      }, 500)
    },
