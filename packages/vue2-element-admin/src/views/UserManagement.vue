<template>
  <div class="user-management">
    ...
    >
      <el-form :model="formData" :rules="formRules" ref="userForm" label-width="100px">
    ...
    fetchUsers() {
      ...
      setTimeout(() => {
        this.userList = [
          ...
          { id: 4, username: 'guest', email: 'guest@example.com', role: 'guest', status: 'active' },
          { id: 5, username: 'manager', email: 'manager@example.com', role: 'admin', status: 'active' }
        ]
