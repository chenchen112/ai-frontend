    ...
    <el-card class="box-card">
      ...
      <div class="content">
        <el-row :gutter="20" style="margin-bottom: 20px;">
          ...
          <el-col :span="4">
            <el-button type="primary" @click="handleAddPermission" icon="el-icon-plus">
              添加权限
            </el-button>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    fetchPermissions() {
      ...
      setTimeout(() => {
        this.permissionList = [
          { id: 1, name: '用户管理', code: 'user:manage', type: 'menu', description: '用户管理菜单' },
          { id: 2, name: '添加用户', code: 'user:add', type: 'button', description: '添加用户按钮' },
          { id: 3, name: '编辑用户', code: 'user:edit', type: 'button', description: '编辑用户按钮' },
          { id: 4, name: '删除用户', code: 'user:delete', type: 'button', description: '删除用户按钮' },
          { id: 5, name: '角色管理', code: 'role:manage', type: 'menu', description: '角色管理菜单' },
          { id: 6, name: '权限管理', code: 'permission:manage', type: 'menu', description: '权限管理菜单' }
        ]
        this.loading = false
      }, 500)
    },
