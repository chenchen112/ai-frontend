    ...
    <el-card class="box-card">
      ...
      <div class="content">
        <el-row :gutter="20" style="margin-bottom: 20px">
          ...
          <el-col :span="4">
            <el-button type="primary" @click="handleGenerate" icon="el-icon-search"> 生成报表 </el-button>
          </el-col>
          <el-col :span="4">
        ...
        <el-tabs v-model="activeTab" @tab-click="handleTabClick">
          <el-tab-pane label="销售报表" name="sales">
            <el-table v-loading="loading" :data="salesReport" border stripe style="width: 100%">
              <el-table-column prop="date" label="日期" width="120"/>
              <el-table-column prop="orders" label="订单数" width="100"/>
              <el-table-column prop="amount" label="销售额" width="120"/>
              <el-table-column prop="avgAmount" label="平均客单价" width="140"/>
              <el-table-column prop="growth" label="环比增长" width="100">
                <template #default="scope">
                  <span
                    :style="{
                      color: scope.row.growth >= 0 ? '#67C23A' : '#F56C6C',
                    }"
                  >
          ...
          <el-tab-pane label="库存报表" name="inventory">
            <el-table v-loading="loading" :data="inventoryReport" border stripe style="width: 100%">
              <el-table-column prop="category" label="分类" width="120"/>
              <el-table-column prop="totalProducts" label="商品总数" width="120"/>
              <el-table-column prop="totalStock" label="总库存" width="100"/>
              <el-table-column prop="lowStock" label="低库存商品" width="120"/>
              <el-table-column prop="value" label="库存价值" width="140"/>
            </el-table>
          </el-tab-pane>

          <el-tab-pane label="用户报表" name="users">
            <el-table v-loading="loading" :data="userReport" border stripe style="width: 100%">
              <el-table-column prop="date" label="日期" width="120"/>
              ...
              <el-table-column prop="retention" label="留存率" width="100">
                <template #default="scope"> {{ scope.row.retention }}% </template>
              </el-table-column>
            </el-table>
          </el-tab-pane>
        </el-tabs>
